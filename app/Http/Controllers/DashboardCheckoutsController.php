...
class DashboardCheckoutsController extends Controller
{
    /**
    ...
    public function destroy(Request $request, Checkout $checkout)
    {
        ...
        $notification = $request->session()->flash("Delete Transaction", "Transaction Has Been Deleted");
        //lalu disini kita akan di return ke halaman dashboard yang otomatis akan mengakses file index
        return redirect("/dashboard/checkouts")->with($notification);
    }
}
